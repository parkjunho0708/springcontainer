...
public class VideoSystemXmlConfigTest {
	...
	public void testDVD7Null() {
		...
		assertEquals(
				"BlankDisc [title=Avengers Director's Edition, studio=MARVEL, actors=[Robert Downey Jr., Scarlett Johansson, Chris Evans]]",
				systemOutRule.getLog().replace("\r\n", "").replace("\n", ""));
	}
	...
	public void testDVD8Null() {
		...
		assertEquals(
				"BlankDisc [title=Avengers Expansion Pack, studio=MARVEL, actors=[Robert Downey Jr., Scarlett Johansson, Chris Evans]]",
				systemOutRule.getLog().replace("\r\n", "").replace("\n", ""));
	}
	...
	public void testDVD9Null() {
		...
		assertEquals(
				"BlankDisc [title=Avengers Expansion Pack2, studio=MARVEL, actors=[Robert Downey Jr., Scarlett Johansson, Chris Evans]]",
				systemOutRule.getLog().replace("\r\n", "").replace("\n", ""));
	}
	...
	public void testPlay4() {
		player4.play();
		assertEquals("Playing Movie MARVEL's Avengers Director's Edition",
				systemOutRule.getLog().replace("\r\n", "").replace("\n", ""));
	}
	...
	public void testPlay5() {
		player5.play();
		assertEquals("Playing Movie MARVEL's Captain America",
				systemOutRule.getLog().replace("\r\n", "").replace("\n", ""));
	}
